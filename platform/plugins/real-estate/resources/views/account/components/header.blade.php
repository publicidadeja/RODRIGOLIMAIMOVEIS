    ...
    <!-- Right Side Of Navbar -->
      <ul class="navbar-nav ml-auto my-2">
        ...
        @else
          ...
          <li>
              <a class="no-underline mr2 black-50 hover-black-70 pv1 ph2 db mr2" style="text-decoration: none; line-height: 32px;" href="{{ route('public.account.crm.index') }}" title="CRM - Gerenciamento de Leads">
                  <i class="fas fa-users mr1"></i>CRM
              </a>
          </li>
